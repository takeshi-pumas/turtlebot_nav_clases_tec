...
if __name__== '__main__':
    ...
    with sm:
        ...
        smach.StateMachine.add("s_2",   S2(),  transitions = {'outcome1':'s_0'})
        smach.StateMachine.add("s_3",   S3(),  transitions = {'outcome1':'s_4'})
        smach.StateMachine.add("s_4",   S4(),  transitions = {'outcome1':'s_0'})
        smach.StateMachine.add("s_5",   S5(),  transitions = {'outcome1':'s_6'})
        smach.StateMachine.add("s_6",   S6(),  transitions = {'outcome1':'s_7'})
        smach.StateMachine.add("s_7",   S7(),  transitions = {'outcome1':'s_8'})
        smach.StateMachine.add("s_8",   S8(),  transitions = {'outcome1':'s_9'})
        smach.StateMachine.add("s_9",   S9(),  transitions = {'outcome1':'s_10'})
        smach.StateMachine.add("s_10",  S10(), transitions = {'outcome1':'s_11'})
        smach.StateMachine.add("s_11",  S11(), transitions = {'outcome1':'s_0'})
